...
! function(win, func) {
    ...
    HbComment.prototype.registerWEvent = function(commentBody) {
        ...
        emoji.addEventListener("click", function() {
            ...
            let htmlArr = ['<div class="emoji-panel emoji"><div class="emoji" style="min-height: 0rem;background-color: #8fabbb"></div>'];
            ...
            htmlArr.push('<div style="clear: both;border-top: 1px solid #f1f1f1;" class="emoji">');
            for (let i = 0; i < emojiArr.length; i++) {
                let active = (i == 0 ? ' active' : '');
